...
left=1in,right=1in,top=1in,bottom=0.75in,%
...
\Large
\centering
\textbf{Monetary Uncertainty as a Determinant of the Response of Stock Market to Macroeconomic News}
\vspace{1cm}
\\
\paragraph{}
by
...
\paragraph{}
Supervised by Professor Alan Moreira
\vspace{1cm}
\paragraph{}
Finance \\
...
\setstretch{1.3}
\pagenumbering{roman}
% \section*{\tetxbf{Table of Contents}} 
% \phantomsection
\tableofcontents
\label{sec:tocc}
...
\section*{\tetxbf{Biographical Sketch}} 
\label{sec:bio}
\addcontentsline{toc}{section}{\nameref{sec:bio}}

The author was born in Kyiv, Ukraine. He attended Kyiv National University and graduated with a Bachelor of Arts and Master of Arts in International Economics. Then he graduated with a Master of Science in Finance from the University of British Columbia. 
He began doctoral studies in Finance at the University of Rochester in 2017. He pursued his research in Empirical Asset Pricing under the direction of Alan Moreira.
...
\section*{\tetxbf{Contributors and Funding Sources}} 
\label{sec:funds}
\addcontentsline{toc}{section}{\nameref{sec:funds}}
This work was supported by a dissertation committee consisting of Professor Alan Moreira, Professor Yukun Liu, and Professor Christian Opp. All work conducted for the dissertation was completed by the student independently. 
...
\section*{\tetxbf{List of tables}} 
\label{sec:tablelist}
\addcontentsline{toc}{section}{\nameref{sec:tablelist}}
...
2004). Then larger $\phi_y$ corresponds to higher monetary uncertainty. When the Fed changes interest rates more aggressively in response to macroeconomic news, the risk-free rate channel becomes stronger. This leads to a larger response to news for bonds and a weaker response for stocks.
\paragraph{}
...
% Table created by stargazer v.5.2.3 by Marek Hlavac, Social Policy Institute. E-mail: marek.hlavac at gmail.com
% Date and time: Tue, Feb 21, 2023 - 11:06:25 AM
\begin{table}[!htbp] \centering 
...
% Q: whats about risk premium? what you call growth channel may be 
% risk premium channel with RD sign. I.e., good news -> lower rp.
% A: it is theoretically reasonable, but inconsistent with my results:
% 1. cross-sectional results.
% 2. - on the one hand, main results, results with MEU and VIX imply lower rp from good news.
%  - on the other hand, term premium regression (see dp_1202 s.31) implies that tp (hence rp) goes up after controlling for monetary channel.
% by contradiction, 2. implies that rp does not move in response to mna surprise.
