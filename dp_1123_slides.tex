...
\begin{frame}{Data}
\begin{itemize}
    \item {Aggregate stock returns: S\&P 500 futures, 1997-2019, 1-minute frequency.}
    \item {Risk-free rate: Fed Funds futures 3 month ahead, Treasury rates at 2, 5 and 10-year maturity, 1998-2019, 1-minute frequency.}
    \item {Individual stocks returns: constituents of S\&P 500, 1997-2019, 5-minute frequency.}
    \item {Low frequency macroeconomic variables from FRED.}
    \item {I use implied volatility of 2-year Treasury rate to proxy for monetary uncertainty (MU).}
\end{itemize}
\end{frame}
...
\begin{itemize}
    \item {I use implied variability (implied volatility times interest rate level) of 2-year Treasury rate to proxy for MU.}
...
\begin{frame}{Monetary uncertainty: ZLB}
    \begin{itemize}
        ...
        \item During a period of ZLB the Fed cannot cut rates
...
\begin{frame}{Different maturities}
    \centering
    \vstretch{0.8}{\includegraphics[width=0.55\textwidth]{images/dp_t11.png}}
\end{frame}
